...
const Reviews = lazy(() => import("./pages/front/Reviews/CourseReview.jsx"));
...
import ReviewList from "./pages/app/review/ReviewList";
...
function RoutesFront() {
    ...
    return (
      <main className="App relative">
        {isFrontOffice && <NavbarFront />}{" "}
        {/* Show NavbarFront for front office paths */}
        <Routes>
          ...
          />
          <Route
            path="/front/courses/:courseId/reviews"
            element={
              <Suspense fallback={<Loading />}>
                <Reviews />
              </Suspense>
          ...
          <Route path="/*" element={<Layout />}>
            ...
            <Route path="dashboard/Review" element={<ReviewList />} />
